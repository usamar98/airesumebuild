...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 px-4 md:px-8 bg-zinc-950">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Let's discuss how we can bring your Web3 vision to life
          </p>
        </motion.div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">contact@web3portfolio.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">web3dev#1234</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
