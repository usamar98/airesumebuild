  ...
  const projects = [
    {
      ...
      description: "A comprehensive media management platform with advanced organization and sharing capabilities.",
    ...
    {
      title: "Loops Studio",
      description: "Creative agency website with immersive animations and interactive elements.",
      image: "https://via.placeholder.com/800x600",
    ...
    },
    {
      ...
      description: "Interactive 3D product visualization with customization options built with Three.js and React.",
      image: "https://via.placeholder.com/800x600",
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="#" className="text-white hover:text-purple-400 transition-colors flex items-center gap-1">
